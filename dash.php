...
<div class="row">
<div class="col-lg-6">
<span class="logo">ACADEMIC INFORMATION SYSTEM</span></div>
<?php
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li><a href="signupa.php">Sign up</a></li>
...
$result = mysqli_query($con,"SELECT * FROM quiz ORDER BY divs DESC") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Physics</b></td><td><b>Chemistry</b></td><td><b>Mathematics</b></td><td><b>GS</b></td><td><b>Average</b></td><td><b>Division</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
  ...
  $math = $row['math'];
  $gs = $row['gs'];
  $avrg =($phys+$chem+$math)/3;
  $divs = $row['divs'];
	$eid = $row['eid'];

	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$phys.'</td><td>'.$chem.'</td><td>'.$math.'</td><td>'.$gs.'</td><td>'.$avrg.'</td><td>'.$divs.'</td>
	<td><b></b></td></tr>';
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter id" class="form-control input-md" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="phys"></label>  
  <div class="col-md-12">
  <input id="phys" name="phys" placeholder="Enter physics" class="form-control input-md" type="number">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="chem"></label>  
  <div class="col-md-12">
  <input id="chem" name="chem" placeholder="Enter chemistry" class="form-control input-md" type="number">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="math"></label>  
  <div class="col-md-12">
  <input id="math" name="math" placeholder="Enter mathematics" class="form-control input-md" min="0" type="number">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="gs"></label>  
  <div class="col-md-12">
  <input id="gs" name="gs" placeholder="Enter Gs" class="form-control input-md" min="0" type="number">
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Details Entered</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"><form class="form-horizontal title1" name="form" action="update.php?q=addqns&eid='.@$_GET['eid'].'&ch=4 "  method="POST">
<fieldset>
';
